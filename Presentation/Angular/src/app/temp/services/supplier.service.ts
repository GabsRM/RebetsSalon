...
export class SupplierService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  apiSupplierGet$Plain(
    params?: {
    },
    context?: HttpContext
  ): Observable<SupplierDtoListResult> {
    return this.apiSupplierGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<SupplierDtoListResult>): SupplierDtoListResult => r.body)
    );
  }
   ...
   */
  apiSupplierPost$Plain$Response(
    params: {
   ...
   * This method doesn't expect any request body.
   */
  apiSupplierIdGet$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
  ...
  apiSupplierIdGet$Plain(
    ...
    return this.apiSupplierIdGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<SupplierDtoResult>): SupplierDtoResult => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  apiSupplierIdGet$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiSupplierIdPut$Plain$Response(
    params: {
      id: string;
      body: SupplierInputDto
    },
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiSupplierIdPut$Json$Response(
    params: {
      id: string;
      body: SupplierInputDto
    },
   ...
   * This method doesn't expect any request body.
   */
  apiSupplierIdDelete$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method doesn't expect any request body.
   */
  apiSupplierIdDelete$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
