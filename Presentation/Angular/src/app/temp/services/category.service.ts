...
export class CategoryService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  apiCategoryGet$Plain(
    params?: {
    },
    context?: HttpContext
  ): Observable<CategoryDtoListResult> {
    return this.apiCategoryGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<CategoryDtoListResult>): CategoryDtoListResult => r.body)
    );
  }
   ...
   */
  apiCategoryPost$Plain$Response(
    params: {
   ...
   * This method doesn't expect any request body.
   */
  apiCategoryIdGet$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
  ...
  apiCategoryIdGet$Plain(
    ...
    return this.apiCategoryIdGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<CategoryDtoResult>): CategoryDtoResult => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  apiCategoryIdGet$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiCategoryIdPut$Plain$Response(
    params: {
      id: string;
      body: CategoryInputDto
    },
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiCategoryIdPut$Json$Response(
    params: {
      id: string;
      body: CategoryInputDto
    },
   ...
   * This method doesn't expect any request body.
   */
  apiCategoryIdDelete$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method doesn't expect any request body.
   */
  apiCategoryIdDelete$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
