...
export class PurchaseService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  apiPurchaseGet$Plain(
    params?: {
    },
    context?: HttpContext
  ): Observable<PurchaseDtoListResult> {
    return this.apiPurchaseGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<PurchaseDtoListResult>): PurchaseDtoListResult => r.body)
    );
  }
   ...
   */
  apiPurchasePost$Plain$Response(
    params: {
   ...
   * This method doesn't expect any request body.
   */
  apiPurchaseIdGet$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
  ...
  apiPurchaseIdGet$Plain(
    ...
    return this.apiPurchaseIdGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<PurchaseDtoResult>): PurchaseDtoResult => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  apiPurchaseIdGet$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method doesn't expect any request body.
   */
  apiPurchaseIdDelete$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method doesn't expect any request body.
   */
  apiPurchaseIdDelete$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
