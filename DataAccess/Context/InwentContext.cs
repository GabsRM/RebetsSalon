...
public partial class InwentContext : DbContext
{
    ...
    public virtual DbSet<HistoricalExchangeRate> HistoricalExchangeRate { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HistoricalExchangeRate>(entity =>
        {
            entity.HasKey(e => e.HistoricalExchangeRateId).HasName("Pk_HistoricalExchangeRate_HistoricalExchangeRateId");

            entity.ToTable(tb => tb.HasComment("Tabla de tasa de cambio histórico por moneda"));

            entity.Property(e => e.HistoricalExchangeRateId).HasComment("Identificador único de registro histórico de tasa de cambio");
            entity.Property(e => e.Date).HasComment("Fecha de tipo de cambio");
        });
        ...
        modelBuilder.Entity<Invoice>(entity =>
        {
            ...
            entity.HasOne(d => d.HistoricalExchangeRate).WithMany(p => p.Invoice)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_Invoice_HistoricalExchangeRate");
        });
