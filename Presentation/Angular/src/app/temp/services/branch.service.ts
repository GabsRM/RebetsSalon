...
export class BranchService extends BaseService {
  ...
  apiBranchGet$Plain(
    ...
    return this.apiBranchGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<BranchDtoListResult>): BranchDtoListResult => r.body)
    );
  }
  ...
  apiBranchIdGet$Plain(
    ...
    return this.apiBranchIdGet$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<BranchDtoResult>): BranchDtoResult => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  apiBranchIdDelete$Plain$Response(
    params: {
      id: string;
    },
    context?: HttpContext
   ...
   * This method doesn't expect any request body.
   */
  apiBranchIdDelete$Json$Response(
    params: {
      id: string;
    },
    context?: HttpContext
